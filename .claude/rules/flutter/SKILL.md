...
slug: flutter
version: 1.0.1
description: Guide for building reliable Flutter/Dart apps. Use this skill when working with Flutter widgets, state management, async operations, navigation, or performance. Covers setState pitfalls, key usage, FutureBuilder, BuildContext lifecycle, and platform channels even if the user doesn't mention these terms explicitly.
paths:
  - "lib/**/*.dart"
  - "test/**/*.dart"
---
